...
export default function UploadImage() {
  ...
  return (
    <div
      className={`p-6 flex flex-col md:flex-row md:items-center md:justify-between bg-neutral-light-grey rounded-xl ${
        error?.profile_picture?.status ? 'border !border-error' : ''
      }`}
    >
